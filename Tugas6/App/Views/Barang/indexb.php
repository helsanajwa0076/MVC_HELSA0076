...
<hr>
        <h1>Daftar Barang</h1>
        <a href="index.php?controller=barang&action=create" a class="btn btn-medium btn-blue">Tambah Data</a>
                ...
                <?php foreach ($data as $key => $barang): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?controller=barang&action=delete&id=<?= $barang['kode_barang'] ?>" class="btn btn-small  btn-red btn-radius">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
