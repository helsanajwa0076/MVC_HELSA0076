...
<body>
    <div class="container">
        ...
        <form action="index.php?controller=pelanggan&action=update" method="POST">
            ...
            <input type="text" id="id_pelanggan" name="id_pelanggan" value="<?= $pelanggan['id_pelanggan'] ?>" required>
        ...
        <a class="btn btn-medium btn-green" onclick="document.forms[0].submit();">Simpan</a>
        <a href="index.php?controller=pelanggan&action=index" class="btn btn-medium btn-gray">Kembali</a>
    </div>
</body>
</html>
